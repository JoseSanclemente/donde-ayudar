...
export const FIGURES: Figure[] = [
  ...
  {
    id: "viviendas_destruidas",
    label: "Viviendas destruidas",
    headline: true,
    departmental: false,
  },
  {
    id: "viviendas_averiadas",
  ...
  {
    id: "familias_afectadas",
    label: "Familias afectadas",
    headline: false,
    departmental: false,
  },
  {
    id: "edificaciones_colapsadas",
    label: "Edificaciones colapsadas",
    headline: false,
    departmental: false,
  },
  {
    id: "sedes_educativas",
    label: "Sedes educativas afectadas",
    headline: false,
    departmental: false,
  },
  {
    id: "centros_salud",
    label: "Centros de salud afectados",
    headline: false,
    departmental: false,
  },
  {
    id: "centros_comunitarios",
    label: "Centros comunitarios afectados",
    headline: false,
    departmental: false,
  },
  ...
  {
    id: "acueductos",
    label: "Acueductos afectados",
    headline: false,
    departmental: false,
  },
  {
    id: "puentes_vehiculares",
    label: "Puentes vehiculares afectados",
    headline: false,
    departmental: false,
  },
  {
    id: "puentes_peatonales",
    label: "Puentes peatonales afectados",
    headline: false,
    departmental: false,
  },
  {
  ...
  {
    id: "fallecidos_caldas",
    label: "Caldas",
    headline: false,
    departmental: true,
  },
  {
    id: "fallecidos_quindio",
    label: "Quindío",
    headline: false,
    departmental: true,
  },
